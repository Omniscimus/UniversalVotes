...
public class UniversalVotes extends JavaPlugin implements Listener {
	...
	public void onEnable() {
		...
		if(votifierEnabled) getServer().getPluginManager().registerEvents(voteListener, this);
		if(remindMessager != null) getServer().getPluginManager().registerEvents(remindMessager, this);
	...
	public void onDisable() {
		...
		if(remindMessager != null) remindMessager.disable();
	}
